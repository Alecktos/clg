...
func NewEndGameScene(onDone func()) (EndGameScene, error) {
	...
	textLayout := view.NewTextLayout(common.Position{X: config.WindowWidth / 2, Y: y1 + 400})
	...
	textLayout = view.NewTextLayout(common.Position{X: config.WindowWidth / 2, Y: y1 + 700})
